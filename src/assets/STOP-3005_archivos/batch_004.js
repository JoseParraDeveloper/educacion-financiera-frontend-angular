;try{window.performance.mark('com.atlassian.jira.plugins.jira-development-integration-plugin_batch_file_eval:start');} catch(e){};;
...
Backbone.define("JIRA.DevStatus.FeedbackDialog",Backbone.Model.extend({properties:["collectorId","summary"],defaults:{summary:"Dinos lo que piensas.",collectorId:"effe8b72"},show:function(){var e=this.get("collectorId");window.ATL_JQ_PAGE_PROPS=window.ATL_JQ_PAGE_PROPS||{},window.ATL_JQ_PAGE_PROPS[e]={fieldValues:{summary:this.get("summary")},triggerFunction:function(e){_.defer(function(){e()})}},AJS.$.getScript(this._collectorUrlFor(e))},_collectorUrlFor:function(e){return"https://jira.atlassian.com/s/d41d8cd98f00b204e9800998ecf8427e/en_UK-7m3tmj-1988229788/6307/131/1.4.8/_/download/batch/com.atlassian.jira.collector.plugin.jira-issue-collector-plugin:issuecollector/com.atlassian.jira.collector.plugin.jira-issue-collector-plugin:issuecollector.js?collectorId="+e}}));;
;
/* module-key = 'com.atlassian.jira.plugins.jira-development-integration-plugin:devstatus-dialog-frame-resources', location = 'jira-development-integration-plugin/templates/common/devstatus-detail-dialog-frame.soy' */
...
;
;
/* module-key = 'com.atlassian.jira.plugins.jira-development-integration-plugin:devstatus-dialog-all-resources', location = 'jira-development-integration-plugin/templates/viewissue/devstatus-detail-dialog.soy' */
...
JIRA.Templates.DevStatus.DetailDialog.authenticationScreen = function(opt_data, opt_ignored) {
  return '<div class="authentication-problem"><div class="image"></div><h2>' + soy.$$escapeHtml(opt_data.title) + '</h2>' + ((opt_data.userError) ? '<p class="user-error">' + soy.$$escapeHtml(opt_data.userError) + '</p>' : '') + ((opt_data.unauthInstances.length > 0) ? '<p>' + soy.$$escapeHtml(AJS.format('Inicia sesi\xf3n para aprobar {0,choice,1#esta aplicaci\xf3n|1\x3cestas aplicaciones}:',opt_data.unauthInstances.length)) + ' <span class="instances"></span></p>' : '') + ((opt_data.otherInstances.length > 0) ? JIRA.Templates.DevStatus.connectionProblemAsWarning({instances: opt_data.otherInstances, showContactAdminForm: opt_data.showContactAdminForm}) : '') + '</div>';
};
if (goog.DEBUG) {
...
;
;
/* module-key = 'com.atlassian.jira.plugins.jira-development-integration-plugin:devstatus-dialog-all-resources', location = 'jira-development-integration-plugin/templates/viewissue/build/devstatus-detail-dialog-build.soy' */
...
JIRA.Templates.DevStatus.DetailDialog.projectContent = function(opt_data, opt_ignored) {
  var output = '<div class="detail-builds-container">' + JIRA.Templates.DevStatus.DetailDialog.projectHeader(opt_data) + '<div class="devstatus-detail-table builds-table' + ((opt_data.withArtifactColumn) ? ' builds-table-with-artifact-column' : '') + '"><table class="aui"><thead><tr><th class="plan">' + soy.$$escapeHtml('Plan') + '</th><th class="build cell-type-collapsed">' + soy.$$escapeHtml('\xdaltimo build') + '</th><th class="result cell-type-collapsed">' + soy.$$escapeHtml('Resultado') + '</th><th class="timestamp cell-type-collapsed">' + soy.$$escapeHtml('Terminado') + '</th>' + ((opt_data.withArtifactColumn) ? '<th class="actions cell-type-collapsed"></th>' : '') + '</tr></thead><tbody>';
...
JIRA.Templates.DevStatus.DetailDialog.buildResult = function(opt_data, opt_ignored) {
  ...
  if ((opt_data.build.buildState == 'SUCCESS' || opt_data.build.buildState == 'FAILED') && opt_data.build.testSummary) {
    ...
    output += '<span>' + ((opt_data.build.testSummary.failedTestCount > 0) ? (opt_data.build.testSummary.successfulTestCount) ? soy.$$escapeHtml(AJS.format('{0} de {1} pruebas no se aprobaron en {2}',opt_data.build.testSummary.failedTestCount,opt_data.build.testSummary.totalTestCount,duration__soy174)) : soy.$$escapeHtml(AJS.format('{0} {0,choice,1#prueba|1\x3cpruebas} no aprobada(s) en {1}',opt_data.build.testSummary.failedTestCount,duration__soy174)) : (opt_data.build.testSummary.successfulTestCount > 0) ? soy.$$escapeHtml(AJS.format('{0} {0,choice,1#prueba|1\x3cpruebas} aprobada(s) en {1}',opt_data.build.testSummary.successfulTestCount,duration__soy174)) : (opt_data.build.buildState == 'SUCCESS') ? soy.$$escapeHtml(AJS.format('Aprobado en {0}',duration__soy174)) : soy.$$escapeHtml(AJS.format('No aprobado en {0}',duration__soy174))) + '</span>';
  } else {
...
JIRA.Templates.DevStatus.DetailDialog.buildResultNoDuration = function(opt_data, opt_ignored) {
  return '' + (((opt_data.build.buildState == 'SUCCESS' || opt_data.build.buildState == 'FAILED') && opt_data.build.testSummary) ? '<span>' + ((opt_data.build.testSummary.failedTestCount > 0) ? (opt_data.build.testSummary.successfulTestCount) ? soy.$$escapeHtml(AJS.format('{0} de {1} pruebas no se aprobaron',opt_data.build.testSummary.failedTestCount,opt_data.build.testSummary.totalTestCount)) : soy.$$escapeHtml(AJS.format('{0} {0,choice,1#prueba|1\x3cpruebas} no aprobada(s)',opt_data.build.testSummary.failedTestCount)) : (opt_data.build.testSummary.successfulTestCount > 0) ? soy.$$escapeHtml(AJS.format('{0} {0,choice,1#prueba|1\x3cpruebas} aprobada(s)',opt_data.build.testSummary.successfulTestCount)) : (opt_data.build.buildState == 'SUCCESS') ? soy.$$escapeHtml('Aprobada') : soy.$$escapeHtml('No aprobada')) + '</span>' : JIRA.Templates.DevStatus.DetailDialog.buildStateName({buildState: opt_data.build.buildState}));
};
if (goog.DEBUG) {
...
JIRA.Templates.DevStatus.DetailDialog.buildStateName = function(opt_data, opt_ignored) {
  ...
  switch (opt_data.buildState) {
    case 'SUCCESS':
      output += soy.$$escapeHtml('Correcto');
      break;
    case 'FAILED':
      output += soy.$$escapeHtml('Error');
      break;
    case 'PENDING':
      output += soy.$$escapeHtml('Pendiente');
      break;
    case 'IN_PROGRESS':
      output += soy.$$escapeHtml('En curso');
      break;
    case 'CANCELLED':
      output += soy.$$escapeHtml('Cancelado');
      break;
    default:
      output += soy.$$escapeHtml('Compilaci\xf3n sin terminar');
  }
  return output;
};
if (goog.DEBUG) {
...
JIRA.Templates.DevStatus.DetailDialog.buildDuration = function(opt_data, opt_ignored) {
  return '' + ((opt_data.build) ? (opt_data.build.durationInSeconds < 1) ? soy.$$escapeHtml('menos de 1 segundo') : (opt_data.build.durationInSeconds < 90) ? soy.$$escapeHtml(AJS.format('{0} {0,choice,1#segundo|1\x3csegundos}',opt_data.build.durationInSeconds)) : (opt_data.build.durationInSeconds < 5400) ? soy.$$escapeHtml(AJS.format('{0} {0,choice,1#minuto|1\x3cminutos}',Math.floor(opt_data.build.durationInSeconds / 60))) : soy.$$escapeHtml(AJS.format('{0} {0,choice,1#hora|1\x3choras}',Math.floor(opt_data.build.durationInSeconds / 60 / 60))) : '');
};
if (goog.DEBUG) {
...
;
;
/* module-key = 'com.atlassian.jira.plugins.jira-development-integration-plugin:devstatus-dialog-all-resources', location = 'jira-development-integration-plugin/templates/viewissue/deployment/devstatus-detail-dialog-deployment.soy' */
...
JIRA.Templates.DevStatus.DetailDialog.Deployment.projectContent = function(opt_data, opt_ignored) {
  var output = '<div class="detail-deployments-container">' + JIRA.Templates.DevStatus.DetailDialog.Deployment.projectHeader(opt_data) + '<div class="devstatus-detail-table deployments-table"><table class="aui"><thead><tr><th class="environment">' + soy.$$escapeHtml('Entorno') + '</th><th class="status cell-type-collapsed">' + soy.$$escapeHtml('Estado') + '</th><th class="release cell-type-collapsed">' + soy.$$escapeHtml('\xdaltima entrega') + '</th><th class="timestamp cell-type-collapsed">' + soy.$$escapeHtml('Implementado por \xfaltima vez') + '</th></tr></thead><tbody>';
...
JIRA.Templates.DevStatus.DetailDialog.Deployment.projectHeader = function(opt_data, opt_ignored) {
  return '<div class="deployments-header"><div class="project-info"><h2 class="ellipsis"><a class="project-link" href="' + soy.$$escapeHtml(opt_data.project.url) + '" title="' + ((opt_data.project.description) ? soy.$$escapeHtml(opt_data.project.description) : soy.$$escapeHtml(opt_data.project.name)) + '">' + soy.$$escapeHtml(opt_data.project.name) + '</a></h2><div class="ellipsis"><strong class="commit-info">' + soy.$$escapeHtml(AJS.format('Las confirmaciones estaban en la entrega {0}',opt_data.project.latestVersions[0].name)) + '</strong></div></div></div>';
};
if (goog.DEBUG) {
...
JIRA.Templates.DevStatus.DetailDialog.Deployment.statusLozenge = function(opt_data, opt_ignored) {
  return '' + ((opt_data.environment.status == 'DEPLOYED') ? '<span class="aui-lozenge aui-lozenge-subtle aui-lozenge-success">' + soy.$$escapeHtml('Implementado') + '</span>' : (opt_data.environment.status == 'FAILED') ? '<span class="aui-lozenge aui-lozenge-subtle aui-lozenge-error">' + soy.$$escapeHtml('Error') + '</span>' : (opt_data.environment.status == 'NOT_DEPLOYED') ? '<span class="aui-lozenge aui-lozenge-subtle">' + soy.$$escapeHtml('No implementado') + '</span>' : '');
};
if (goog.DEBUG) {
...
;
;
/* module-key = 'com.atlassian.jira.plugins.jira-development-integration-plugin:devstatus-dialog-all-resources', location = 'jira-development-integration-plugin/templates/viewissue/devstatus-detail-dialog-commit.soy' */
...
JIRA.Templates.DevStatus.DetailDialog.commit = function(opt_data, opt_ignored) {
  var output = '' + ((opt_data.canCreateReview) ? '<div class="aui-group aui-group-split"><div class="aui-item"></div><div class="aui-item"><div class="create-review-instance"><a href="#">' + soy.$$escapeHtml('Crear revisi\xf3n de todas las confirmaciones') + '</a></div></div></div>' : '');
...
JIRA.Templates.DevStatus.DetailDialog.commitContent = function(opt_data, opt_ignored) {
  var output = '<div class="detail-commits-container' + ((opt_data.repository.showReviews) ? ' has-reviews' : '') + ((opt_data.repository.showBranches) ? ' has-branches' : '') + ((opt_data.repository.showFiles) ? ' has-files' : '') + ' ' + ((opt_data.repository.showCreateReview) ? 'has-actions' : '') + '" data-repository-index="' + soy.$$escapeHtml(opt_data.repositoryIndex) + '" >' + JIRA.Templates.DevStatus.DetailDialog.repositoryHeader(soy.$$augmentMap(opt_data, {showParent: true, extraProjectInfo: '' + ((opt_data.repository.showInstance && opt_data.repository.instance) ? '<div class="repository-instance" title="' + soy.$$escapeHtml(opt_data.repository.instance.name) + '">(' + soy.$$escapeHtml(opt_data.repository.instance.name) + ')</div>' : ''), extraContent: '' + ((opt_data.repository.showFiles) ? '<div class="file-expand"><a href="#">' + soy.$$escapeHtml('Mostrar todos los archivos') + '</a></div>' : '')})) + '<div class="devstatus-detail-table commits-table"><table class="aui"><thead><tr><th class="author cell-type-collapsed">' + soy.$$escapeHtml('Autor') + '</th><th class="changeset cell-type-collapsed">' + soy.$$escapeHtml('Confirmaci\xf3n') + '</th><th class="message">' + soy.$$escapeHtml('Mensaje') + '</th>' + ((opt_data.repository.showBranches) ? '<th class="branches"></th>' : '') + ((opt_data.repository.showReviews) ? '<th class="reviews">' + soy.$$escapeHtml('Revisiones') + '</th>' : '') + '<th class="timestamp">' + soy.$$escapeHtml('Fecha') + '</th>' + ((opt_data.repository.showFiles) ? '<th class="filecount">' + soy.$$escapeHtml('Archivos') + '</th>' : '') + ((opt_data.repository.showCreateReview) ? '<th class="commit-actions">' + soy.$$escapeHtml('Acciones') + '</th>' : '') + '</tr></thead><tbody>';
...
JIRA.Templates.DevStatus.DetailDialog.mergeLozenge = function(opt_data, opt_ignored) {
  return '<span class="aui-lozenge merge" title="' + soy.$$escapeHtml('Esta confirmaci\xf3n es una combinaci\xf3n') + '">' + soy.$$escapeHtml('M') + '</span>';
};
if (goog.DEBUG) {
...
JIRA.Templates.DevStatus.DetailDialog.branchesTooltip = function(opt_data, opt_ignored) {
  ...
  output += ((opt_data.branchData.totalCount > opt_data.branchData.branches.length) ? '<div class="branch-tooltip-summary">' + soy.$$escapeHtml(AJS.format('y {0} m\xe1s',opt_data.branchData.totalCount - opt_data.branchData.branches.length)) + '</div>' : '') + '</span>';
  return output;
};
if (goog.DEBUG) {
...
JIRA.Templates.DevStatus.DetailDialog.actionsColumn = function(opt_data, opt_ignored) {
  return '<td class="commit-actions">' + ((opt_data.commit.createReviewUrl) ? '<div class="create-review-commit"><a href="' + soy.$$escapeHtml(opt_data.commit.createReviewUrl) + '">' + soy.$$escapeHtml('Crear revisi\xf3n') + '</a></div>' : '') + '</td>';
};
if (goog.DEBUG) {
...
JIRA.Templates.DevStatus.DetailDialog.filesColumn = function(opt_data, opt_ignored) {
  return '<td class="filecount">' + ((opt_data.count > 0) ? '<a href="#" class="extra-content-in-title" title="' + soy.$$escapeHtml('Hacer clic para mostrar archivos') + '">' + ((opt_data.count < 100) ? soy.$$escapeHtml(AJS.format('{0} {0,choice,1#archivo|1\x3carchivos}',opt_data.count)) : soy.$$escapeHtml(AJS.format('{0}+ archivos',100))) + '</a>' : '') + '</td>';
};
if (goog.DEBUG) {
...
JIRA.Templates.DevStatus.DetailDialog.reviewsInlineDialog = function(opt_data, opt_ignored) {
  ...
  output += ((opt_data.reviewData.totalCount > opt_data.reviewData.reviews.length) ? '<tr><td class="inline-review-summary" colspan="2">' + ((opt_data.reviewData.url) ? '<a href="' + soy.$$escapeHtml(opt_data.reviewData.url) + '">' + soy.$$escapeHtml(AJS.format('y {0} m\xe1s',opt_data.reviewData.totalCount - opt_data.reviewData.reviews.length)) + '</a>' : '<span>' + soy.$$escapeHtml(AJS.format('y {0} m\xe1s',opt_data.reviewData.totalCount - opt_data.reviewData.reviews.length)) + '</span>') + '</td></tr>' : '') + '</tbody></table>';
  return output;
};
if (goog.DEBUG) {
...
;
;
/* module-key = 'com.atlassian.jira.plugins.jira-development-integration-plugin:devstatus-dialog-all-resources', location = 'jira-development-integration-plugin/templates/viewissue/commit/devstatus-detail-dialog-commit-files.soy' */
...
JIRA.Templates.DevStatus.DetailDialog.Commit.Files.fileRow = function(opt_data, opt_ignored) {
  ...
  for (var fileIndex3 = 0; fileIndex3 < fileListLen3; fileIndex3++) {
    ...
    output += (fileIndex3 < opt_data.max) ? '<div class="file"><div class="change">' + ((fileData3.linesAdded != null && fileData3.linesRemoved != null) ? '<div class="lines">' + ((fileData3.changeType == 'ADDED') ? '<span class="aui-lozenge added">' + soy.$$escapeHtml('A\xf1adido') + '</span>' : (fileData3.changeType == 'DELETED') ? '<span class="aui-lozenge removed">' + soy.$$escapeHtml('Eliminada') + '</span>' : '<span class="aui-lozenge added count">+' + soy.$$escapeHtml(fileData3.linesAdded) + '</span><span class="aui-lozenge removed count">-' + soy.$$escapeHtml(fileData3.linesRemoved) + '</span>') + '</div>' : '<div class="changetype">' + JIRA.Templates.DevStatus.DetailDialog.Commit.Files.fileChangeLozenge({changeType: fileData3.changeType}) + '</div>') + '</div><div class="filename ellipsis">' + ((fileData3.url) ? '<a href="' + soy.$$escapeHtml(fileData3.url) + '" title="' + soy.$$escapeHtml(fileData3.path) + '">' + soy.$$escapeHtml(fileData3.path) + '</a>' : soy.$$escapeHtml(fileData3.path)) + '</div></div>' : '';
  }
  return output;
};
if (goog.DEBUG) {
...
JIRA.Templates.DevStatus.DetailDialog.Commit.Files.moreFiles = function(opt_data, opt_ignored) {
  ...
  if (opt_data.files.length < opt_data.fileCount) {
    if (opt_data.moreFilesUrl) {
      output += '<a class="more-files-info" href="' + soy.$$escapeHtml(opt_data.moreFilesUrl) + '">' + soy.$$escapeHtml(AJS.format('Ver m\xe1s archivos en {0}',opt_data.instanceName)) + '</a>';
    } else {
      var notShownFileCount__soy56 = opt_data.fileCount - opt_data.files.length;
      output += '<span class="more-files-info">' + soy.$$escapeHtml(AJS.format('y {0} m\xe1s',notShownFileCount__soy56)) + '</span>';
    }
  }
  return output;
};
...
JIRA.Templates.DevStatus.DetailDialog.Commit.Files.fileChangeLozenge = function(opt_data, opt_ignored) {
  ...
  switch (opt_data.changeType) {
    case 'ADDED':
      text__soy61 += soy.$$escapeHtml('A\xf1adido');
      break;
    case 'COPIED':
      text__soy61 += soy.$$escapeHtml('Copiado');
      break;
    case 'DELETED':
      text__soy61 += soy.$$escapeHtml('Eliminada');
      break;
    case 'MOVED':
      text__soy61 += soy.$$escapeHtml('Movida');
      break;
    default:
      text__soy61 += soy.$$escapeHtml('Modificado');
  }
  var class__soy73 = '';
  switch (opt_data.changeType) {
    case 'ADDED':
...
;
;
/* module-key = 'com.atlassian.jira.plugins.jira-development-integration-plugin:devstatus-dialog-all-resources', location = 'jira-development-integration-plugin/templates/viewissue/devstatus-detail-dialog-branch-pullrequest.soy' */
...
JIRA.Templates.DevStatus.DetailDialog.pullRequest = function(opt_data, opt_ignored) {
  return '<div class="detail-pullrequests-container"><div class="devstatus-detail-table pullrequests-table"><table class="aui"><thead><tr><th class="pullrequest-id">' + soy.$$escapeHtml('ID') + '</th><th class="title">' + soy.$$escapeHtml('T\xedtulo') + '</th><th class="state">' + soy.$$escapeHtml('Estado') + '</th><th class="author">' + soy.$$escapeHtml('Autor') + '</th><th class="reviewer">' + soy.$$escapeHtml('Revisor') + '</th><th class="comment cell-type-collapsed"></th><th class="last-updated">' + soy.$$escapeHtml('Actualizada') + '</th></tr></thead><tbody>' + JIRA.Templates.DevStatus.DetailDialog.pullRequestEntry(opt_data) + '</tbody></table></div></div>';
};
if (goog.DEBUG) {
...
JIRA.Templates.DevStatus.DetailDialog.commentCount = function(opt_data, opt_ignored) {
  return '' + ((opt_data.pullRequest.commentCount) ? '<div class="comment-container"><a class="comment-link" href="' + soy.$$escapeHtml(opt_data.pullRequest.url) + '" title="' + soy.$$escapeHtml('Comentarios') + '"><span class="aui-icon aui-icon-small aui-iconfont-comment">Comments</span></a><span class="count">' + soy.$$escapeHtml(opt_data.pullRequest.commentCount) + '</span></div>' : '');
};
if (goog.DEBUG) {
...
JIRA.Templates.DevStatus.DetailDialog.branch = function(opt_data, opt_ignored) {
  return '<div class="detail-branches-container"><div class="devstatus-detail-table branches-table"><table class="aui"><thead><tr><th class="repository">' + soy.$$escapeHtml('Repositorio') + '</th><th class="branch">' + soy.$$escapeHtml('Rama') + '</th>' + ((opt_data.features.lastCommitId) ? '<th class="changeset cell-type-collapsed">' + soy.$$escapeHtml('\xdaltima confirmaci\xf3n') + '</th>' : '') + ((opt_data.features.lastCommitTimestamp) ? '<th class="last-updated cell-type-collapsed">' + soy.$$escapeHtml('Modificado por \xfaltima vez') + '</th>' : '') + ((opt_data.features.pullRequests) ? '<th class="pullrequest">' + soy.$$escapeHtml('Solicitud de extracci\xf3n') + '</th>' : '') + ((opt_data.features.reviews) ? '<th class="review">' + soy.$$escapeHtml('Revisi\xf3n') + '</th>' : '') + ((opt_data.features.pullRequests || opt_data.features.reviews) ? '<th class="action">' + soy.$$escapeHtml('Acci\xf3n') + '</th>' : '') + '</tr></thead><tbody>' + JIRA.Templates.DevStatus.DetailDialog.branchEntry(opt_data) + '</tbody></table></div></div>';
};
if (goog.DEBUG) {
...
JIRA.Templates.DevStatus.DetailDialog.pullRequestState = function(opt_data, opt_ignored) {
  return '' + JIRA.Templates.FusionWidget.Common.reviewsState({isSubtle: opt_data.isSubtle, state: opt_data.status, stateClasses: {OPEN: 'aui-lozenge-complete', MERGED: 'aui-lozenge-success', DECLINED: 'aui-lozenge-error'}, stateText: {OPEN: 'ABIERTA', MERGED: 'COMBINADA', DECLINED: 'RECHAZADA'}, classes: 'pullrequest-state'});
};
if (goog.DEBUG) {
...
;
;
/* module-key = 'com.atlassian.jira.plugins.jira-development-integration-plugin:devstatus-dialog-all-resources', location = 'jira-development-integration-plugin/templates/viewissue/devstatus-detail-dialog-review.soy' */
...
JIRA.Templates.DevStatus.DetailDialog.review = function(opt_data, opt_ignored) {
  var output = '<div class="devstatus-detail-table detail-reviews-container"><div class="devstatus-detail-table reviews-table"><table class="aui"><thead><tr><th class="review cell-type-collapsed">' + soy.$$escapeHtml('ID') + '</th><th class="title">' + soy.$$escapeHtml('T\xedtulo') + '</th><th class="state cell-type-collapsed">' + soy.$$escapeHtml('Estado') + '</th><th class="author cell-type-collapsed">' + soy.$$escapeHtml('Autor') + '</th><th class="reviewer cell-type-collapsed">' + soy.$$escapeHtml('Revisores') + '</th><th class="comment cell-type-collapsed"></th><th class="timestamp">' + soy.$$escapeHtml('Fecha') + '</th></tr></thead><tbody>';
...
;
;
/* module-key = 'com.atlassian.jira.plugins.jira-development-integration-plugin:devstatus-dialog-all-resources', location = 'jira-development-integration-plugin/templates/viewissue/review/devstatus-panel-review.soy' */
...
JIRA.Templates.DevStatus.Review.summaryPanel = function(opt_data, opt_ignored) {
  return '<dl><dt>' + JIRA.Templates.DevStatus.transitionContainer({content: '<div class="summary-content"><a class="summary" href="#" title="' + soy.$$escapeHtml(AJS.format('Revisiones relacionadas con {0}',opt_data.issueKey)) + '">' + JIRA.Templates.FusionWidget.Common.reviewsText(opt_data) + '</a> ' + JIRA.Templates.FusionWidget.Common.reviewsStateViewIssue(opt_data) + '</div>'}) + '</dt>' + JIRA.Templates.DevStatus.Review.reviewDate(soy.$$augmentMap(opt_data, {showUpdatedText: true})) + '</dl>';
};
if (goog.DEBUG) {
...
JIRA.Templates.DevStatus.Review.reviewDate = function(opt_data, opt_ignored) {
  return '' + ((opt_data.dueDate && ! opt_data.completed) ? JIRA.Templates.DevStatus.lastUpdated({text: 'Vencimiento', lastUpdated: opt_data.dueDate, extraClass: opt_data.overDue ? 'overdue' : undefined, datetimeFormat: 'fullAge'}) : (opt_data.lastUpdated) ? JIRA.Templates.DevStatus.lastUpdated({text: opt_data.showUpdatedText ? 'Actualizada' : '', lastUpdated: opt_data.lastUpdated, datetimeFormat: 'fullAge'}) : '');
};
if (goog.DEBUG) {
...
;
;
/* module-key = 'com.atlassian.jira.plugins.jira-development-integration-plugin:devstatus-dialog-all-resources', location = 'jira-development-integration-plugin/js/util/Helpers.js' */
